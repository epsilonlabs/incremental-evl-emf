...
public class PropertyAccessImpl extends AccessImpl implements PropertyAccess {
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.PROPERTY_ACCESS;
	}
	...
	public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.PROPERTY_ACCESS__PROPERTY, oldProperty, property));
	}

...
public class FlowchartsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlowchartsPackage.FLOWCHART: {
				Flowchart flowchart = (Flowchart)theEObject;
				T result = caseFlowchart(flowchart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartsPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartsPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartsPackage.EDGE: {
			...
			case FlowchartsPackage.DECISION: {

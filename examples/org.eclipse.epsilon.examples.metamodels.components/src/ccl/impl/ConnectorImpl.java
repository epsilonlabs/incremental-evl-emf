 ...
 * </p>
 * <ul>
 *   <li>{@link ccl.impl.ConnectorImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ccl.impl.ConnectorImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorImpl extends MinimalEObjectImpl.Container implements Connector {
	...
	protected EClass eStaticClass() {
		return CclPackage.Literals.CONNECTOR;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CclPackage.CONNECTOR__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public InPort getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			target = (InPort)eResolveProxy(oldTarget);
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CclPackage.CONNECTOR__TARGET, oldTarget, target));
			}
		}
		return target;
	}

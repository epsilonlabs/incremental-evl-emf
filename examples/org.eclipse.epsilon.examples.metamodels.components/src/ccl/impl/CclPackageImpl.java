...
public class CclPackageImpl extends EPackageImpl implements CclPackage {
	...
	public static CclPackage init() {
		if (isInited) return (CclPackage)EPackage.Registry.INSTANCE.getEPackage(CclPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCclPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CclPackageImpl theCclPackage = registeredCclPackage instanceof CclPackageImpl ? (CclPackageImpl)registeredCclPackage : new CclPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, ccl.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_Components(), this.getComponent(), null, "components", null, 0, -1, ccl.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Connectors(), this.getConnector(), null, "connectors", null, 0, -1, ccl.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConnector_Source(), this.getOutPort(), null, "source", null, 0, 1, Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConnector_Target(), this.getInPort(), null, "target", null, 0, 1, Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPort_Type(), ecorePackage.getEString(), "type", "boolean", 0, 1, Port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
